# Generated by Django 2.2.5 on 2020-05-19 14:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='逻辑删除')),
                ('hbook_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='booktest.BookInfo', verbose_name='书籍编号')),
            ],
            options={
